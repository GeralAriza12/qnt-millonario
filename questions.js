window.QNT_QUESTIONS = [
  {
    "question": "¿Qué es una objeción en el proceso comercial?",
    "options": [
      "Una excusa para no pagar",
      "Una duda o resistencia del cliente",
  ...
  },
  {
    ...
    "options": [
      "Aumentar su deuda",
      "Quedar a paz y salvo y recuperar puntaje crediticio",
  ...
  },
  {
    ...
    "options": [
      "Vender solo por redes",
      "Integración de múltiples canales para una experiencia coherente",
  ...
  },
  {
    ...
    "options": [
      ...
      "Escuchar, empatizar y ofrecer soluciones adaptadas",
  ...
  },
  {
    ...
    "options": [
      "Una herramienta de inventario",
      "Un método: Situación, Problema, Implicación, Necesidad de solución",
      "Un tipo de cliente",
  ...
  },
  {
    ...
    "options": [
      "Forzarlo a decidir",
      "Proveer pruebas, transparencia y tiempo",
      "Ignorar sus dudas",
  ...
  },
  {
    ...
    "options": [
      "Solo prensa escrita",
      "Podcasts y colaboraciones con influencers",
  ...
  },
  {
    ...
    "options": [
      "Tono distinto por canal",
      "Un tono cercano, profesional y coherente",
  ...
  },
  {
    ...
    "options": [
      "Ignorando su comportamiento",
      "Escuchando activamente y adaptando el discurso",
  ...
  },
  {
    ...
    "options": [
      "Solo captar nuevos clientes",
      "Cambiar estrategia siempre",
  ...
  },
  {
    ...
    "options": [
      "Solo responder sin preguntar",
      "Escuchar activamente, preguntar y responder claro",
